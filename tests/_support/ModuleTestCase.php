...
class ModuleTestCase extends \CodeIgniter\Test\CIDatabaseTestCase
{
	/**
	...
	public function setUp(): void
	{
		...
		if ($tmpReset === true)
		{
			...
			// Run all detectable migrations
			$this->migrations->setNamespace(false);
			$this->migrations->latest('tests');

			// Seed the database
			$this->seed('ModuleTests\Support\Database\Seeds\MythSeeder');
		}
	...
	/**
	 * Returns faked data for a conversation.
	 *
	 */
	...
	/**
	 * Returns class name for a random vali Font Awesome icon
	 *
	 */
